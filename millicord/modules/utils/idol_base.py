...
class IdolBase(Client):
    ...
    def find_config(self, module: IdolModuleType, path: Union[Path, str]) -> IdolConfigItemType:
    ...
    def find_script(self, module: IdolModuleType, path: Path) -> IdolScriptItemType:
        module_identifier = get_module_identifier(module)
